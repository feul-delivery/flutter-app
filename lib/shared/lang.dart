class Language {
  ...
  static Map<String, String> mapFR = {
    ...
    'deliveryqr': "en attendant d'être scanné par le livreur",
    'pickcolor': 'Choisissez une couleur',
    'matricule': 'Matricule',
    'nodescription': 'Pas de description',
    'choose': 'Choisir',
    'confirm': 'Confirmer',
    'workrequest': 'Demandes de travail',
  ...
  static Map<String, String> mapEN = {
    ...
    'redirectClToLv':
        "chargement..., vous serez bientôt redirigé vers l'espace livreur",
    'deliveryqr': 'expecting to be scanned by the delivery man',
